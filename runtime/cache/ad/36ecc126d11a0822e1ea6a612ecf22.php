<?php
//000000000000a:3:{s:11:"orderAction";s:52422:"<style>
...
function update_pay_status(order_id) {
	$.ajax({
		type : 'post',
		url : "http://www.shop.com/index.php?s=/admin/order/getOrderUpdatePayStatus",
		data : { "order_id" : order_id },
		success : function(data){
...
function updatePayStatusSubmit() {
	...
	$.ajax({
		type : 'post',
		url : "http://www.shop.com/index.php?s=/admin/order/updatePaystatus",
		data : {
			"order_id" : order_id,
...
function update_delivery_status(order_id) {
	$.ajax({
		type : 'post',
		url : "http://www.shop.com/index.php?s=/admin/order/getDeliveryStatus",
		data : { "order_id" : order_id },
		success : function(data){
...
function updateDeliveryStatusSubmit() {
	...
	$.ajax({
		type : 'post',
		url : "http://www.shop.com/index.php?s=/admin/order/updateDeliveryStatus",
		data : {
			"order_id" : order_id,
...
</script>";s:16:"orderPrintAction";s:31267:"<style>
.cell .is_Increment{
	margin-left: 10px;
}	
.is_Increment{
