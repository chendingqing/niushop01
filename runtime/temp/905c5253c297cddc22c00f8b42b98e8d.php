<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:44:"template/adminblue\Cms\articleClassList.html";i:1553151902;s:28:"template/adminblue\base.html";i:1553151902;s:45:"template/adminblue\controlCommonVariable.html";i:1553151902;s:32:"template/adminblue\urlModel.html";i:1553151902;s:34:"template/adminblue\pageCommon.html";i:1553151902;s:34:"template/adminblue\openDialog.html";i:1553151902;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		...
		<tbody>
			...
			<tr class="pid_0" style="height: 30px;">
				<td>
					...
					<a href="javascript:;" onclick="tab_switch(<?php echo $v1['class_id']; ?>)" class="tab_jia_<?php echo $v1['class_id']; ?>" style="display: block;">[+]</a>
					<a href="javascript:;" onclick="tab_switch(<?php echo $v1['class_id']; ?>)" class="tab_jian_<?php echo $v1['class_id']; ?>" style="display: none;">[-]</a>
					<?php endif; ?>
				</td>
				
				<td style="text-align: left;"><input type="text" class="input-common" fieldid="<?php echo $v1['class_id']; ?>" fieldname="name" value="<?php echo $v1['name']; ?>"></td>
				<td>
					<input type="number" class="input-common input-common-sort" min="0" onkeyup="value=value.replace(/[^\d+(\.\d+)?]/g,'')" fieldid="<?php echo $v1['class_id']; ?>" fieldname="sort" value="<?php echo $v1['sort']; ?>" >
				</td>
			...
			<tr class="pid_<?php echo $v1['class_id']; ?>" style="height: 30px; display: none;">
				...
				<td>
					<input type="number" class="input-common input-common-sort" min="0" onkeyup="value=value.replace(/[^\d+(\.\d+)?]/g,'')" fieldid="<?php echo $v2['class_id']; ?>" fieldname="sort" value="<?php echo $v2['sort']; ?>" >
				</td>
				<td style="text-align: center;">
	...
	$.ajax({
		...
		success:function(res){
			...
			if(res['code']>0){
				...
				location.href = "<?php echo __URL('ADMIN_MAIN/cms/articleclasslist'); ?>";
			}else{
