<?php if (!defined('THINK_PATH')) exit(); /*a:14:{s:38:"template/shop\blue\Index\discount.html";i:1553151902;s:28:"template/shop\blue\base.html";i:1553151902;s:32:"template/shop\blue\urlModel.html";i:1553151902;s:34:"template/shop\blue\controlTop.html";i:1553157362;s:41:"template/shop\blue\controlHeadSerach.html";i:1553151902;s:43:"template/shop\blue\controlHeadGoodType.html";i:1553151902;s:40:"template/shop\blue\controlCommonNav.html";i:1553151902;s:44:"template/shop\blue\Index\controlHeadNav.html";i:1553160225;s:43:"template/shop\blue\controlRightSidebar.html";i:1553151902;s:41:"template/shop\blue\controlCommonPage.html";i:1553151902;s:45:"template/shop\blue\controlBottomLinkHelp.html";i:1553151902;s:37:"template/shop\blue\controlBottom.html";i:1553151902;s:36:"template/shop\blue\controlLogin.html";i:1553151902;s:37:"template/shop\blue\baidu_js_push.html";i:1553151902;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<style type="text/css">
.classify-box .classify-screen-con a{width: 129px;}
.classify-box .classify-screen-con .classify-choose{ width: 96%;}
.category-layer-bg{ background: rgba(6, 137, 225, 0.42);}
.category-layer .list .cat .cat-name a{color: #fff;}
.category-layer .list .categorys{background: rgba(238, 238, 238, 0.91)};
</style>
...
-->
<?php $service = new data\service\Platform;$list = $service->getPlatformAdvPositionDetail("1056", "*");$list = json_encode($list);$list = json_decode($list, ture); if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): ?>
...
<div class="w1210">
	<div class="classify-screen">
		<div class="classify-box clearfix">
			<h5 class="classify-name"><?php echo lang('classification_goods'); ?>：</h5>
			<div class="classify-screen-con">
				<div class="classify-choose">
					<?php if($category_id == 0): ?>
						<a target="_self" href="<?php echo __URL('SHOP_MAIN/'.$path_info); ?>" class="selected" style="height: 45px;float: left;width:66px;"><span><?php echo lang('whole'); ?></span></a>
					<?php else: ?>
						<a target="_self" href="<?php echo __URL('SHOP_MAIN/'.$path_info); ?>" style="height: 45px;float: left;width:66px;"><span><?php echo lang('whole'); ?></span></a>
					<?php endif; if(is_array($goods_category_one) || $goods_category_one instanceof \think\Collection || $goods_category_one instanceof \think\Paginator): $i = 0; $__LIST__ = $goods_category_one;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['category_id'] == $category_id): ?>
						<a target="_self" href="<?php echo __URL('SHOP_MAIN/'.$path_info,'category_id='.$vo['category_id']); ?>" class="selected" title="<?php echo $vo['category_name']; ?>"><span><?php echo $vo['category_name']; ?></span></a>
						<?php else: ?>
						<a target="_self" href="<?php echo __URL('SHOP_MAIN/'.$path_info,'category_id='.$vo['category_id']); ?>" title="<?php echo $vo['category_name']; ?>"><span><?php echo $vo['category_name']; ?></span></a>
						<?php endif; endforeach; endif; else: echo "" ;endif; ?>
				</div>
			</div>
		</div>
...
<div class="main">
	<ul class="row-4">
		...
		<li>
			<a class="scope" href="<?php echo __URL('SHOP_MAIN/goods/goodsinfo','goodsid='.$vo['goods_id']); ?>" title="<?php echo $vo['goods_name']; ?>">
				<div class="p-img">
					<img alt="" src="<?php echo __IMG($default_goods_img); ?>" class="lazy_load" data-original="<?php echo __IMG($vo['picture']['pic_cover_mid']); ?>">
...
<!-- 					</div> -->
				...
				<div class="goods-price"><span class="sale"><?php echo lang('promotional_price'); ?><em><?php echo $vo['display_price']; ?></em></span>
					<!-- <span class="depreciate"><i class="fa fa-down"></i><?php echo lang('straight_down'); ?>：¥<?php echo $vo['sale_down']; ?></span> -->
				</div>
<!-- 				</div> -->
				<div class="brand-info">
					<div class="b-price clearfix">
						...
						<div class="fr">
							...
							<span class="main-btn bg-color"><?php echo lang('snap_up'); ?></span>
						</div>
					</div>
				</div>
			</a>
...
<div id="pagination" class="page" >
	...
	<div class="page-num fr">
		...
		<div id="page_list" style="float: left;<?php echo $path_info; ?>">
			...
			<!-- 总页数小于总页码时就都显示 -->
			<?php if($page_count <= $page_num): $__FOR_START_7666__=1;$__FOR_END_7666__=$page_count+1;for($i=$__FOR_START_7666__;$i < $__FOR_END_7666__;$i+=1){ if($i == $page): ?>
			...
			<?php elseif($page <= ($page_num-1)/2): $__FOR_START_7421__=1;$__FOR_END_7421__=$page_num+1;for($i=$__FOR_START_7421__;$i < $__FOR_END_7421__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info.'?page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 如果总页数等于当前页 或者 总页数小于当前页加上页码总数平均值显示 -->
			<?php elseif($page_count == $page or $page_count <= $page+($page_num-1)/2): $__FOR_START_21844__=$page_count-$page_num+1;$__FOR_END_21844__=$page_count+1;for($i=$__FOR_START_21844__;$i < $__FOR_END_21844__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info.'?page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 否则就正常显示 -->
			<?php else: $__FOR_START_27815__=$page-($page_num-1)/2;$__FOR_END_27815__=$page+($page_num-1)/2+1;for($i=$__FOR_START_27815__;$i < $__FOR_END_27815__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info.'?page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } endif; ?>
