...
<style>
.fr{ width:1200px; background-color: #fff; }
...
.create_time{ text-align: center; width: 100%;display: block;line-height: 30px; }
...
<div class="content w990 clearfix">
	<div class="breadcrumb clearfix" style="margin: 10px 10px 5px auto;">
		<a href="<?php echo __URL('SHOP_MAIN/index'); ?>" class="index"><?php echo lang('home_page'); ?></a>
		<span class="crumbs-arrow">&gt;</span>
		<a href="<?php echo __URL('SHOP_MAIN/notice/noticeList'); ?>"><span class="last"><?php echo lang('notice'); ?></span></a>
	</div>
	<!-- 内容部分 -->
	<div class="fr" id="question">
		<div class="right-inner">
			<h3 class="help-tit"><?php echo $info['notice_title']; ?></h3>
			<time class="create_time">发布时间：<?php echo date("Y-m-d H:i:s",$info['create_time']); ?> &nbsp;&nbsp;&nbsp;&nbsp;</time>
			<div class="help-detail">
				<p style="color: #666666;"><?php echo html_entity_decode($info['notice_content']); ?></p>
			</div>
			<div class="location_other_article">
				...
				<a href="<?php echo __URL('SHOP_MAIN/notice/detail', 'id='.$prev_info['id']); ?>" class="prev">上一篇：<?php echo $prev_info['notice_title']; ?></a>
				<?php endif; if(!(empty($next_info) || (($next_info instanceof \think\Collection || $next_info instanceof \think\Paginator ) && $next_info->isEmpty()))): ?>
				<a href="<?php echo __URL('SHOP_MAIN/notice/detail', 'id='.$next_info['id']); ?>" class="next">下一篇：<?php echo $next_info['notice_title']; ?></a>
				<?php endif; ?>
			</div>
		</div>
	</div>
