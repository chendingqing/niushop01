				...
				<table width="100%" border="0" cellpadding="10" cellspacing="1" bgcolor="#eeeeee">
					...
					<tr>
				 	...
				 	<tr>
                  		...
                  		<td align="left"><input name="mobile" type="text" class="inputBg" id="phone" value="<?php echo $address_info['phone']; ?>" />
	                  	</td>
	                </tr> 
					<tr>
