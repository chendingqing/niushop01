<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:51:"template/adminblue\Config\updateShopNavigation.html";i:1553151902;s:28:"template/adminblue\base.html";i:1553151902;s:45:"template/adminblue\controlCommonVariable.html";i:1553151902;s:32:"template/adminblue\urlModel.html";i:1553151902;s:34:"template/adminblue\pageCommon.html";i:1553151902;s:34:"template/adminblue\openDialog.html";i:1553151902;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
		...
		<dd><input id="nav_title" type="text" value="<?php echo $data['nav_title']; ?>" name="title" class="input-common"/></dd>
	</dl>
	<dl>
		<dt>排序号：</dt>
		<dd><input id="sort" type="number" value="<?php echo $data['sort']; ?>" name="" min="0" class="input-common harf"/></dd>
	</dl>
	<dl>
		<dt>所属类型：</dt>
		<dd>
			<div id="position_type">
				...
				<i class="radio-common <?php if($data['type'] == 1): ?>selected<?php endif; ?>"><input type="radio" value="1" name="navigationtype" id="navigationtype1" <?php if($data['type'] == 1): ?>checked="checked"<?php endif; ?>/></i>
				<span>PC端</span>
				</label>
				<label for="navigationtype2" class="radio inline normal">
				<i class="radio-common <?php if($data['type'] == 2): ?>selected<?php endif; ?>"><input type="radio" value="2" name="navigationtype" id="navigationtype2" <?php if($data['type'] == 2): ?>checked="checked"<?php endif; ?>/></i>
				<span>手机端</span>
				</label>
			</div>
		</dd>
	...
	<dl>
		...
		<dd>
			...
			<i class="radio-common <?php if($data['nav_type'] == 0): ?>selected<?php endif; ?>"><input type="radio" value="0" name="url_type" id="url_type1" <?php if($data['nav_type'] == 0): ?>checked="checked"<?php endif; ?>/></i>
			<span>商城模块</span>
			</label>
			<label for="url_type2" class="radio inline normal">
			<i class="radio-common <?php if($data['nav_type'] == 1): ?>selected<?php endif; ?>"><input type="radio" value="1" name="url_type" id="url_type2" <?php if($data['nav_type'] == 1): ?>checked="checked"<?php endif; ?>/></i>
			<span>自定义链接</span>
			</label>
		</dd>
	</dl>
	<dl>
		...
		<dd>
			...
			<span style="<?php if($data['nav_type'] != 1): ?>display: none;<?php endif; ?>" id="nav_url">
				<input type="text" value="<?php echo $data['nav_url']; ?>" name="nav_url" class="input-common"/>
	...
	<dl>
		...
		<dd>
			<p>
				<input id="is_blank" type="checkbox"  class="checkbox"  <?php if($data['is_blank'] == 1): ?>checked<?php endif; ?>/>
			</p>
		</dd>
	</dl>
	<dl>
		...
		<dd>
			<p>
				<input id="is_show" type="checkbox"  class="checkbox"  <?php if($data['is_show'] == 1): ?>checked<?php endif; ?>/>
			</p>
		</dd>
	</dl>
	<dl>
		...
		<dd>
			<div class="upload-btn-common">
				<div>
					...
					<input type="hidden" id="logo" value="<?php echo $data['nav_icon']; ?>" />
				</div>
				<input type="text" id="text_logo" class="input-common" readonly="readonly" value="<?php if($data['nav_icon']): ?><?php echo $data['nav_icon']; endif; ?>" />
				<em>上传</em>
				
				<img id="preview_logo" src="__STATIC__/blue/img/upload-common-select.png" <?php if($data['nav_icon']): ?>data-src="<?php echo __IMG($data['nav_icon']); ?>"<?php endif; ?> data-html="true" data-container="body" data-placement="top" data-trigger="manual"/>
			</div>
...
<script type="text/javascript">
$(function(){
	var nav_type = "<?php echo $data['nav_type']; ?>";
	if(nav_type == "1") $(".selectric-select-common").hide();
	
	var navigationtype="<?php echo $data['type']; ?>";
...
function save(){
	...
	$.ajax({
		type:"post",
		url:"<?php echo __URL('ADMIN_MAIN/config/updateshopnavigation'); ?>",
		data:{
			'nav_id':nav_id,
			'nav_title':nav_title,
			'sort':sort,
...
function switchUseType(use_type){
	var shopNavTemplateJson = '<?php echo $shopNavTemplateJson; ?>';
