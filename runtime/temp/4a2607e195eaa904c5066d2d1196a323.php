...
<div class="set-style">
	<dl>
		...
		<dd>
			<input id="title" type="text" class="input-common" value="<?php echo $info['notice_title']; ?>" />
	...
	<dl>
		...
		<dd>
			<p>
				<input id="sort" type="number" onkeyup="this.value=this.value.replace(/\D/g,'')" class="input-common harf" value="<?php echo $info['sort']; ?>" />
...
var ue = UE.getEditor('editor',{ "initialFrameHeight" : 450});
	ue.ready(function() {
		ue.setContent('<?php echo html_entity_decode($info['notice_content']); ?>', false);
	});
//验证数据
