<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:44:"template/adminblue\System\updateShopAdv.html";i:1553151902;s:28:"template/adminblue\base.html";i:1553151902;s:45:"template/adminblue\controlCommonVariable.html";i:1553151902;s:32:"template/adminblue\urlModel.html";i:1553151902;s:34:"template/adminblue\pageCommon.html";i:1553151902;s:34:"template/adminblue\openDialog.html";i:1553151902;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
		...
		<dd>
			<p><input id="adv_title" type="text" value="<?php echo $adv_info['adv_title']; ?>" class="input-common long"></p>
		...
		<dd>
			<p>
				<select name="" id="ap_id" class="form-control input-sm input-common">
					<option value="0" <?php if($adv_info['ap_id'] == 0): ?>selected<?php endif; ?>>请选择广告位</option>
					<?php if(!(empty($platform_adv_position_list) || (($platform_adv_position_list instanceof \think\Collection || $platform_adv_position_list instanceof \think\Paginator ) && $platform_adv_position_list->isEmpty()))): if(is_array($platform_adv_position_list) || $platform_adv_position_list instanceof \think\Collection || $platform_adv_position_list instanceof \think\Paginator): if( count($platform_adv_position_list)==0 ) : echo "" ;else: foreach($platform_adv_position_list as $key=>$vo): ?>
						<option value="<?php echo $vo['ap_id']; ?>" <?php if($adv_info['ap_id'] == $vo['ap_id']): ?>selected<?php endif; ?> ap-class="<?php echo $vo['ap_class']; ?>"><?php echo $vo['ap_name']; ?></option>
						<?php endforeach; endif; else: echo "" ;endif; endif; ?>
				</select>
			</p>
	...
	<div class="data-image">
			...
			<dd>
				<div class="upload-btn-common">
					<div>
						...
						<input type="hidden" id="adv" value="<?php echo $adv_info['adv_image']; ?>">
					</div>
					
					<input type="text" id="text_adv" class="input-common" readonly="readonly" value="<?php echo $adv_info['adv_image']; ?>">
					<em>上传</em>								
					<img id="preview_adv" src="__STATIC__/blue/img/upload-common-select.png" data-src="<?php echo __IMG($adv_info['adv_image']); ?>" data-html="true" data-container="body" data-placement="top" data-trigger="manual" data-original-title="" title="">
				</div>
		...
		<dl>
			<dt>背景色：</dt>
			<dd>
				<input id="background" type="color" style="width:60px;height:25px;" value="<?php echo $adv_info['background']; ?>" class="input-common-color"/>
			</dd>
		</dl>
		<dl>
			<dt><span class="color-red">*</span>链接地址：</dt>
			<dd>
				<p><input id="adv_url" type="text" value="<?php echo $adv_info['adv_url']; ?>" class="input-common long"></p>
	...
	<dl>
		...
		<dd>
			<p><input id="slide_sort" type="number" value="<?php echo $adv_info['slide_sort']; ?>" class="input-common harf"></p>
	...
	<div class="data-code" style="display: none;">
		<dl>
			...
			<dd>
				...
				<textarea name="" id="adv_code" cols="30" rows="10"><?php echo $adv_info['adv_code']; ?></textarea>
				<div id="show">
