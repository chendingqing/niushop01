<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:44:"template/adminblue\Config\addHomeNotice.html";i:1553151902;s:28:"template/adminblue\base.html";i:1553151902;s:45:"template/adminblue\controlCommonVariable.html";i:1553151902;s:32:"template/adminblue\urlModel.html";i:1553151902;s:34:"template/adminblue\pageCommon.html";i:1553151902;s:34:"template/adminblue\openDialog.html";i:1553151902;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
function save(){
	...
	if(verification(title,sort,content)){
		...
		if(!flag){
			...
			$.ajax({
				type : "post",
				url : "<?php echo __URL('ADMIN_MAIN/config/addOrModifyHomeNotice'); ?>",
				data : {
					'title' : title,
					'content' : content,
					'sort' : sort
				...
				success : function(data){
					if(data['code'] > 0){
						...
						location.href = "<?php echo __URL('ADMIN_MAIN/config/userNotice'); ?>";
					}else{
						showTip("发布失败","error");
					}
					flag = false;
