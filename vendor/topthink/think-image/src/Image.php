...
class Image
{
    ...
    public function crop($w, $h, $x = 0, $y = 0, $width = null, $height = null)
    {
        ...
        do {
            ...
            // 调整默认颜色
            $color = imagecolorallocatealpha($img , 0 , 0 , 0 , 127);//拾取一个完全透明的颜色，不要用imagecolorallocate拾色
...
//                 }
                ...
                do {
                    ...
                    $img = imagecreatetruecolor($width, $height);
                    // 调整默认颜色
                    $color = imagecolorallocatealpha($img , 255 , 255 , 255 , 127);//拾取一个完全透明的颜色，不要用imagecolorallocate拾色         
                    imagealphablending($img , false);//关闭混合模式，以便透明颜色能覆盖原画板     
                    imagefill($img , 0 , 0 , $color);//填充   
                    //$color = imagecolorallocate($img, 255, 255, 255);
                    //imagefill($img, 0, 0, $color);
